...
},{"./..\\images\\demo.jpg":[["demo.3a1bb503.jpg","images/demo.jpg"],"images/demo.jpg"],"_css_loader":"../node_modules/parcel-bundler/src/builtins/css-loader.js"}],"../node_modules/notiflix/dist/notiflix-aio-3.2.2.min.js":[function(require,module,exports) {
var define;
...
},{"./lib/axios":"../node_modules/axios/lib/axios.js"}],"js/fetch-photos.js":[function(require,module,exports) {
"use strict";
...
var _fetchPhotos = _interopRequireDefault(require("./js/fetch-photos"));

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

const form = document.querySelector('.search-form'); // const input = document.querySelector('input[type="text"]');

const button = document.querySelector('button[type="submit"]');
const gallery = document.querySelector('.gallery');
const loadMoreButton = document.querySelector('.load-more');
const fetchToIP = new _fetchPhotos.default();
...
async function handleSubmitOnForm(event) {
  ...
  if (fetchToIP.request === '') {
    loadMoreButton.classList.add(`is-hidden`);
    loadMoreButton.setAttribute(`disabled`, true);
    return _notiflix.default.Notify.warning(`Oops! You need to enter some value`);
  }

  try {
    fetchToIP.getFetchPhotos().then(hits => {
...
function handleAddCreateGallery(hits) {
  ...
  _notiflix.default.Notify.success(`Hooray! We found ${totalHits} images for you`);
